...
import { ShaderParams, useMetallicPaintWebGL } from '../../hooks/useMetallicPaintWebGL'
...
export default function MetallicPaint({
  ...
  useMetallicPaintWebGL(canvasRef, imageData, params, vertexShaderSource, liquidFragSource)
