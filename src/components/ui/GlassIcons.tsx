...
// BookBed color gradients - using our primary purple palette
const gradientMapping: Record<string, string> = {
  primary: 'linear-gradient(hsl(253, 68%, 61%), hsl(268, 75%, 65%))', // Primary purple gradient
  secondary: 'linear-gradient(hsl(283, 90%, 70%), hsl(268, 90%, 75%))', // Light purple gradient
  accent: 'linear-gradient(hsl(243, 75%, 58%), hsl(253, 80%, 62%))', // Deep purple gradient
  emerald: 'linear-gradient(hsl(158, 64%, 52%), hsl(160, 84%, 39%))', // Success green
  blue: 'linear-gradient(hsl(223, 90%, 50%), hsl(208, 90%, 50%))', // Info blue
  amber: 'linear-gradient(hsl(43, 90%, 50%), hsl(28, 90%, 50%))', // Warning amber
};
